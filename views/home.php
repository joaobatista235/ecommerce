    ...
    <div class="outter">
        <form id="loginForm" class="form">
            <div class="form-item">
                ...
                <input type="email" name="email" id="email" class="form-item-input" placeholder="email@address.com"
                       required>
            </div>
            <div class="form-item password-container">
                <label for="password" class="form-item-label">Password</label>
                <div class="input-wrapper">
                    <input type="password" name="password" id="password" class="form-item-input" placeholder="password"
                           required>
