    ...
    class Cliente implements GenericInterface
    {
        ...
        public function getById(int $id): ?Cliente
        {
            ...
            if ($data = mysqli_fetch_assoc($result)) {
                ...
                foreach ($data as $key => $value) {
                    // Capitalize the first letter and remove underscores from column names
        ...
        public function getAll(): array
        {
            ...
            while ($data = mysqli_fetch_assoc($result)) {
                ...
                // Manually map each column to the corresponding setter method
                if (isset($data['id'])) {
                ...
                // Add the cliente object to the array
                $clientes[] = $cliente;
            }
